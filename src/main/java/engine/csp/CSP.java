...
public class CSP<VAR extends Variable, VAL> implements Cloneable {
    ...
    /**
     * Replaces the engine.csp.domain of the specified variable by new engine.csp.domain, which
     * contains all values of the old engine.csp.domain except the specified value.
     */
    ...
    /**
     * Returns all engine.csp.constraints in which the specified variable participates.
     */
    ...
    /**
     * Returns for binary engine.csp.constraints the other variable from the scope.
     *
     * @return a variable or null for non-binary engine.csp.constraints.
     */
